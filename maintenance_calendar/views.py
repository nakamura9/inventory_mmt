...
class MonthView(TemplateView):
    template_name=os.path.join("maintenance_calendar","month_view.html")
...
class WeekView(TemplateView):
    template_name=os.path.join("maintenance_calendar","week_view.html")
...
class DayView(TemplateView):
    template_name=os.path.join("maintenance_calendar","day_view.html")
