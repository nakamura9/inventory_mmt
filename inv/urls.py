...
import views
spares_urls = [
    url(r'^spares-details/(?P<pk>[\w ]+)/?$', views.SparesDetail.as_view(), 
        name="spares-details"),
    url(r'^spares-create/?$', views.SparesCreate.as_view(), 
        name="spares-create"),
    url(r'^spares-update/(?P<pk>[\w ]+)/?$', views.SparesUpdate.as_view(), 
        name="spares-update"),
...
asset_urls = [
    url(r'^asset-details/(?P<pk>[\d]+)/?$', views.AssetDetail.as_view(), 
        name="asset-details"),
    url(r'^asset-create/?$', views.AssetCreate.as_view(), name="asset-create"),
    url(r'^asset-update/(?P<pk>[\d]+)/?$', views.AssetUpdate.as_view(), 
        name="asset-update"),
    ]
...
component_urls =[     
    ...
    url(r'^add_component/?$', views.ComponentCreateView.as_view(), 
        name="add_component"),
...
machine_urls = [
    ...
    url(r'^add_machine/?$', views.MachineCreateView.as_view(), 
        name="add_machine"),
...
subunit_urls = [
    url(r'edit_subunit/(?P<pk>[ -~]+)/?$', views.SubunitEditView.as_view(), 
        name="edit_subunit"),
    url(r'^add_subunit/?$', views.SubUnitCreateView.as_view(),
        name="add_subunit"),
    url(r'^subunit_details/(?P<pk>[ -~]+)/?$', views.SubUnitView.as_view(), 
        name="subunit_details"),
    url(r'delete_subunit/([ -~]+)/?$', views.delete_subunit, 
        name="delete_subunit"),
]
...
subassembly_urls = [
    ...
    url(r'^add_subassembly/?$', views.SubAssyCreateView.as_view(), 
...
section_urls = [
    url(r'^add_section/$', views.SectionCreateView.as_view(), 
        name="add_section"),
